...
beautiful.init("/home/ryan/.config/awesome/themes/autumn/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "j", function () mymainmenu:show() end),
    ...
    awful.key({ modkey,           }, "e", function () awful.util.spawn("cd ~/ripcord/spock && emacs &") end),
...
--    awful.key({}, "#67",      function (c) c.fullscreen = not c.fullscreen  end),
